...
' UI cellák (függőleges elrendezés)
...
Public Sub TeremNevsor_UI_InstallOrRefresh()
    ...
    ' Tisztítjuk a felső területet (A1:C4)
    ws.Range("A1:C4").clear

    ' Label-ek (függőlegesen)
...
Public Sub TeremNevsor_Generalas()
    ...
    ' Töröljük az előző lista régiót (A9:C...)
...
Private Sub ExportRosterToPdf(ws As Worksheet, printLastRow As Long, committee As String, dayKey As String, room As String)
    ...
    If Not FolderExists(basePath) Then
        ...
        End If
        MsgBox "A hálózati mappa nem elérhető. PDF ide kerül: " & basePath, vbExclamation, "Mentési hely"
...
' ============================================================
' Időpontok: tbl_idopontok(datum_nap, aktiv)
' ============================================================
