...
' Excelből fut: Word dokumentumot megnyitja / csatlakozik és PDF-ekre bontja
Public Sub SavePagesGroupedByRowChange_Excel(Optional control As IRibbonControl)
    ...
    xStart = AskLong("Kezdő oldal?", "PDF bontás", 1)
    ...
    For i = xStart To xEnd
        ...
        ' Ha megváltozott a kulcs, mentsük az előző csoportot
