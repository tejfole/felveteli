...
Public Sub TEST_IdopontRendszer()
    ...
    If loT Is Nothing Then
        MsgBox "NINCS időpont tábla (GetIdopontTabla_V2 Nothing).", vbCritical
        Exit Sub
    End If

    MsgBox "OK: megvan az időpont tábla." & vbCrLf & _
           "Lap: " & loT.parent.Name & vbCrLf & _
           "Tábla: " & loT.Name & vbCrLf & _
           "Sorok: " & loT.ListRows.Count, vbInformation

    ' teszt listázás: írjunk ki 1-2 aktív időpontot
    If loT.ListRows.Count = 0 Then
        MsgBox "Az időpont tábla üres. Vegyél fel időpontot!", vbExclamation
        Exit Sub
    End If
    ...
    Dim r As Long, msg As String: msg = "Első 10 sor:" & vbCrLf
