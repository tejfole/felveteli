...
Public Sub FrissitListaTablat(Optional control As IRibbonControl, _
    ...
    If tbl Is Nothing Then
        If Not Csendes Then MsgBox "Nem található a 'lista' nevû tábla.", vbCritical
        Exit Sub
    End If
    ...
    If valasztas = "" Then
        If Not Csendes Then MsgBox "A B1 cellában nincs kiválasztott szûrési feltétel.", vbExclamation
        Exit Sub
    End If
    ...
    If darab = 0 Then
        ...
        If Not Csendes Then
            MsgBox "Nincs találat a kiválasztott szûrésre: " & valasztas, vbInformation
        End If
