...
Public Sub Beallitasok_Menu(Optional control As IRibbonControl)
    ...
    Do
        ...
        Select Case choice
            ...
            Case "6"
                PickFileForSetting KEY_OSSZESITO_TEMPLATE, "Válaszd ki az összesítõlap Word sablont", "Word dokumentumok", "*.doc;*.docx;*.docm"
            Case "7"
...
Private Function BuildSettingsMenuText() As String
    BuildSettingsMenuText = _
        ...
        "  6. Összesítõlap Word sablon" & vbCrLf & _
        "  7. Pontozó kimeneti mappa" & vbCrLf & _
        vbCrLf & _
        "A beállítások a " & SETTINGS_SHEET_NAME & " lapon is szerkeszthetõk." & vbCrLf & _
        "Kilépés: Mégse / üres"
End Function
...
Private Sub PrepareSettingsSheet(ws As Worksheet)
    ...
    EnsureSettingRow ws, KEY_OSSZESITO_TEMPLATE, "Összesítõlap Word sablon", DEFAULT_OSSZESITO_TEMPLATE
